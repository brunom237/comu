...
\begin{obs}
  El protocolo Neighbor Discovery es el mecanismo estándar de IPv6 utilizado por los nodos para descubrir la topología local, determinar las direcciones MAC de los vecinos y mantener información de estado sobre la alcanzabilidad de las rutas.
  
  Sus funciones principales incluyen:
  \begin{itemize}
    \item \textbf{Resolución de direcciones:} Reemplaza a ARP. Permite a un nodo determinar la dirección MAC de un vecino a partir de su dirección IPv6, eliminando el broadcast y utilizando en su lugar mensajes ICMPv6 sobre direcciones multicast Solicited-Node.
    \item \textbf{Descubrimiento de routers:} Permite a los hosts localizar automáticamente a los routers residentes en el enlace físico adjunto.
  \end{itemize}
\end{obs}
